...
const fr: Record<string, string> = {
  ...
  'kit.edit': 'Modifier',
  'kit.expired': 'Expire',
  'kit.limit_reached': 'Limite d\'articles atteinte (Version gratuite)',
  'kit.rpg_title': 'Survival RPG',
  'kit.rpg_subtitle': 'Évaluez votre mentalité de survie',
  'kit.rpg_desc': 'Répondez au quiz de 5 questions pour découvrir votre archétype de survie et débloquer des badges exclusifs.',
  'kit.rpg_start': 'Commencer le test',
  'kit.rpg_restart': 'Recommencer le test',
  'kit.rpg_close': 'Fermer',
  'kit.rpg_result_title': 'Votre Archétype',
  'kit.rpg_q1': 'Une panne d\'électricité générale survient. Quelle est votre première action ?',
  'kit.rpg.q1.a': 'Vérifier Twitter/X tout de suite',
  'kit.rpg.q1.b': 'Sortir les bougies et allumer la radio FM',
  'kit.rpg.q1.c': 'Vérifier le disjoncteur et rassurer les voisins',
  'kit.rpg.q1.d': 'Rien, tout est déjà prêt (solaire/batteries)',
  'kit.rpg.profile.novice': 'NOVICE',
  'kit.rpg.profile.initie': 'INITIÉ',
  'kit.rpg.profile.preparateur': 'PRÉPARATEUR',
  'kit.rpg.profile.survivant': 'SURVIVANT',
  'kit.rpg.profile.novice_desc': 'Vous commencez tout juste. Un peu de préparation peut tout changer.',
  'kit.rpg.profile.initie_desc': 'Vous avez les bases, mais quelques jours d\'autonomie en plus seraient prudents.',
  'kit.rpg.profile.preparateur_desc': 'Vous êtes sérieux et organisé. La plupart des crises ne vous surprendront pas.',
  'kit.rpg.profile.survivant_desc': 'Vous êtes une force de la nature. Votre préparation est exemplaire.',
...
const en: Record<string, string> = {
  ...
  'kit.edit': 'Edit',
  'kit.expired': 'Expired',
  'kit.limit_reached': 'Item limit reached (Free version)',
  'kit.rpg_title': 'Survival RPG',
  'kit.rpg_subtitle': 'Evaluate your survival mindset',
  'kit.rpg_desc': 'Take the 5-question quiz to discover your survival archetype and unlock exclusive badges.',
  'kit.rpg_start': 'Start quiz',
  'kit.rpg_restart': 'Restart quiz',
  'kit.rpg_close': 'Close',
  'kit.rpg_result_title': 'Your Archetype',
  'kit.rpg_q1': 'There is a major power outage. What is your first action?',
  'kit.rpg.q1.a': 'Check Twitter/X immediately',
  'kit.rpg.q1.b': 'Get the candles and turn on FM radio',
  'kit.rpg.q1.c': 'Check the breaker and reassure neighbors',
  'kit.rpg.q1.d': 'Nothing, everything is already ready (solar/batteries)',
  'kit.rpg.profile.novice': 'NOVICE',
  'kit.rpg.profile.initie': 'INITIATED',
  'kit.rpg.profile.preparateur': 'PREPARER',
  'kit.rpg.profile.survivant': 'SURVIVOR',
  'kit.rpg.profile.novice_desc': 'You are just starting. A little preparation can change everything.',
  'kit.rpg.profile.initie_desc': 'You have the basics, but a few more days of autonomy would be prudent.',
  'kit.rpg.profile.preparateur_desc': 'You are serious and organized. Most crises won\'t surprise you.',
  'kit.rpg.profile.survivant_desc': 'You are a force of nature. Your preparation is exemplary.',
